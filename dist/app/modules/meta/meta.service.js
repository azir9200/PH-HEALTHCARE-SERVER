...
const getSuperAdminMetaData = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const totalUserDataBar = yield getBarUserData();
    return {
        appointmentCount,
        patientCount,
        doctorCount,
...
const getBarUserData = () => __awaiter(void 0, void 0, void 0, function* () {
    const userIndividualData = yield prisma_1.default.$queryRaw `
        SELECT DATE_TRUNC('month', "createdAt") AS month,
        CAST(COUNT(*) AS INTEGER) AS count
        FROM "users"
        GROUP BY month
...
const getPieChartData = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const formattedAppointmentStatusDistribution = appointmentStatusDistribution.map(({ role, _count }) => ({
        role,
        count: Number(_count.id),
    }));
